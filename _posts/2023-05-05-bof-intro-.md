---
layout: single
title: '<span class="vulnhub">BOF explicacion - /VulnHub</span>'
excerpt: "Bufferoverflows estan en todas partes desde las certificaciónes de introducción hasta las más difíciles aquí usaremos un ejemplo intermedio"
date: 2024-05-03
categories:
  - Article
tags:  
...
BOF o bufferoverflow's o desbormiento del buffer se da simplemente cuando metemos tantas caracteres en una app que aparece segmentation fault asi de simple 
...
- Difficulty assigned by me: Medium

Let's get them!

Primero la idea es hacer un precheck o un pre análisis de el binario 
...
look the output it's 2 this is a measure to prevent buffer overflow attacks, but it can be bypassed when we are analyzing the program. I'll explain it to you
